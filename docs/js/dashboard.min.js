...
"use strict";angular.module("RDash").config(["$stateProvider","$urlRouterProvider",function(e,t){t.otherwise("/"),e.state("index",{url:"/",templateUrl:"templates/dashboard.html"}).state("expense",{url:"/expense",templateUrl:"templates/expense.html"}).state("income",{url:"/income",templateUrl:"templates/income.html"}).state("account",{url:"/account",templateUrl:"templates/account.html"})}]);
...
function MasterCtrl(e,t,a){e.dataList=[{type:"query",text:"Hello, What can I do for you?"},{type:"query",text:"1. To add an expense, type expense"},{type:"query",text:"2. To add an account, type account"},{type:"query",text:"3. To add an income, type income"}],e.response={},e.submitQuery=function(){e.response.type="response",e.dataList.push(e.response);var t=e.response.text;a(function(){e.dataList.push(evaluateQuery(t))},2e3),e.response={}}}function evaluateQuery(e){var t={};console.log(e),t.type="query";switch(e){case"expense":t.text="Expense has been added";break;case"income":t.text="Income has been added";break;case"account":t.text="Account has been added"}return t}angular.module("RDash").controller("MasterCtrl",["$scope","$cookieStore","$timeout",MasterCtrl]);
